...
Calibration is a versioned, held-out empirical gate. A fitted scorer is not automatically eligible to route. Validation requires disjoint contexts, a tail slice, error bounds, and quality/sample thresholds; these are operational checks, not a guarantee of future quality.
